...
Fakerwiki is a library for local testing of Python
ScraperWiki:"http://http://scraperwiki.com/" scripts.  Mostly
it's just a copy of the ScraperWiki library with the database bits removed.
...
GPLv3 (same as
ScraperWiki:"https://kforgehosting.com/scraperwiki/trac/browser/LICENSE.txt")
